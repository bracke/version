...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_platform_ci_evidence" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6f52e324#;
   pragma Export (C, u00001, "check_platform_ci_evidenceB");
