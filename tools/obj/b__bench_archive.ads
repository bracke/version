...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_bench_archive" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#658d6603#;
   pragma Export (C, u00001, "bench_archiveB");
   ...
   u00189 : constant Version_32 := 16#a52776f2#;
   pragma Export (C, u00189, "version__archiveB");
   u00190 : constant Version_32 := 16#0d4c9128#;
   pragma Export (C, u00190, "version__archiveS");
   ...
   u00206 : constant Version_32 := 16#0a3df331#;
   pragma Export (C, u00206, "version__filesB");
   u00207 : constant Version_32 := 16#d797020d#;
   pragma Export (C, u00207, "version__filesS");
   u00208 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00208, "ada__streams__stream_ioB");
   u00209 : constant Version_32 := 16#5dc4c9e4#;
   pragma Export (C, u00209, "ada__streams__stream_ioS");
   u00210 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00210, "system__communicationB");
   u00211 : constant Version_32 := 16#bb9c8d3c#;
   pragma Export (C, u00211, "system__communicationS");
   u00212 : constant Version_32 := 16#cb531dd3#;
   pragma Export (C, u00212, "version__files__internalB");
   u00213 : constant Version_32 := 16#ef8b1a80#;
   pragma Export (C, u00213, "version__files__internalS");
   u00214 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00214, "gnatS");
   u00215 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00215, "gnat__os_libS");
   u00216 : constant Version_32 := 16#dd257eb8#;
   pragma Export (C, u00216, "version__files__rollbackB");
   u00217 : constant Version_32 := 16#8430c226#;
   pragma Export (C, u00217, "version__files__rollbackS");
   u00218 : constant Version_32 := 16#f730cf34#;
   pragma Export (C, u00218, "version__filesystem_guardB");
   u00219 : constant Version_32 := 16#323327a2#;
   pragma Export (C, u00219, "version__filesystem_guardS");
   u00220 : constant Version_32 := 16#203dc005#;
   pragma Export (C, u00220, "version__path_safetyB");
   u00221 : constant Version_32 := 16#08f1eb7d#;
   pragma Export (C, u00221, "version__path_safetyS");
   u00222 : constant Version_32 := 16#9ee87d13#;
   pragma Export (C, u00222, "version__platformB");
   u00223 : constant Version_32 := 16#d34d0f79#;
   pragma Export (C, u00223, "version__platformS");
   u00224 : constant Version_32 := 16#8d235f7e#;
   pragma Export (C, u00224, "ada__environment_variablesB");
   u00225 : constant Version_32 := 16#767099b7#;
   pragma Export (C, u00225, "ada__environment_variablesS");
   u00226 : constant Version_32 := 16#58c21abc#;
   pragma Export (C, u00226, "interfaces__c__stringsB");
   u00227 : constant Version_32 := 16#bd4557ce#;
   pragma Export (C, u00227, "interfaces__c__stringsS");
   u00228 : constant Version_32 := 16#60dcc575#;
   pragma Export (C, u00228, "version__object_cacheB");
   u00229 : constant Version_32 := 16#1dfef07c#;
   pragma Export (C, u00229, "version__object_cacheS");
   u00230 : constant Version_32 := 16#db9dd4a5#;
   pragma Export (C, u00230, "version__packB");
   u00231 : constant Version_32 := 16#3d772bf4#;
   pragma Export (C, u00231, "version__packS");
   u00232 : constant Version_32 := 16#1bdf4749#;
   pragma Export (C, u00232, "version__hashB");
   u00233 : constant Version_32 := 16#ee7b81db#;
   pragma Export (C, u00233, "version__hashS");
   u00234 : constant Version_32 := 16#070dfa59#;
   pragma Export (C, u00234, "version__pack_indexB");
   u00235 : constant Version_32 := 16#944b3eba#;
   pragma Export (C, u00235, "version__pack_indexS");
   u00236 : constant Version_32 := 16#1edfa670#;
   pragma Export (C, u00236, "version__objectsB");
   u00237 : constant Version_32 := 16#66c15d81#;
   pragma Export (C, u00237, "version__objectsS");
   u00238 : constant Version_32 := 16#44b34b03#;
   pragma Export (C, u00238, "version__compressionB");
   u00239 : constant Version_32 := 16#4eabb8a5#;
   pragma Export (C, u00239, "version__compressionS");
   u00240 : constant Version_32 := 16#3ad840e5#;
   pragma Export (C, u00240, "zlibB");
   u00241 : constant Version_32 := 16#9b7d9fc9#;
   pragma Export (C, u00241, "zlibS");
   u00242 : constant Version_32 := 16#7e239593#;
   pragma Export (C, u00242, "zlib__bit_writerB");
   u00243 : constant Version_32 := 16#97d2a07b#;
   pragma Export (C, u00243, "zlib__bit_writerS");
   u00244 : constant Version_32 := 16#8668c60d#;
   pragma Export (C, u00244, "zlib__block_chooserB");
   u00245 : constant Version_32 := 16#a38f219b#;
   pragma Export (C, u00245, "zlib__block_chooserS");
   u00246 : constant Version_32 := 16#02d3ebec#;
   pragma Export (C, u00246, "zlib__deflate_tablesB");
   u00247 : constant Version_32 := 16#d36f2066#;
   pragma Export (C, u00247, "zlib__deflate_tablesS");
   u00248 : constant Version_32 := 16#df91fc6b#;
   pragma Export (C, u00248, "zlib__huffmanB");
   u00249 : constant Version_32 := 16#a02ed816#;
   pragma Export (C, u00249, "zlib__huffmanS");
   u00250 : constant Version_32 := 16#3c6bf20b#;
   pragma Export (C, u00250, "zlib__bitsB");
   u00251 : constant Version_32 := 16#37cfd778#;
   pragma Export (C, u00251, "zlib__bitsS");
   u00252 : constant Version_32 := 16#69d79c60#;
   pragma Export (C, u00252, "zlib__stream_bitsB");
   u00253 : constant Version_32 := 16#e757f448#;
   pragma Export (C, u00253, "zlib__stream_bitsS");
   u00254 : constant Version_32 := 16#502d00b1#;
   pragma Export (C, u00254, "zlib__fixed_compressB");
   u00255 : constant Version_32 := 16#0f6ccf11#;
   pragma Export (C, u00255, "zlib__fixed_compressS");
   u00256 : constant Version_32 := 16#99853839#;
   pragma Export (C, u00256, "zlib__checksumsB");
   u00257 : constant Version_32 := 16#60db1c89#;
   pragma Export (C, u00257, "zlib__checksumsS");
   u00258 : constant Version_32 := 16#dd25c8e9#;
   pragma Export (C, u00258, "zlib__lz77_matcherB");
   u00259 : constant Version_32 := 16#2c08e160#;
   pragma Export (C, u00259, "zlib__lz77_matcherS");
   u00260 : constant Version_32 := 16#986d251a#;
   pragma Export (C, u00260, "zlib__huffman_builderB");
   u00261 : constant Version_32 := 16#c4db564e#;
   pragma Export (C, u00261, "zlib__huffman_builderS");
   u00262 : constant Version_32 := 16#3a0a2521#;
   pragma Export (C, u00262, "zlib__crc32_internalB");
   u00263 : constant Version_32 := 16#54dd0ae1#;
   pragma Export (C, u00263, "zlib__crc32_internalS");
   u00264 : constant Version_32 := 16#273c1bb0#;
   pragma Export (C, u00264, "zlib__sliding_windowB");
   u00265 : constant Version_32 := 16#18522695#;
   pragma Export (C, u00265, "zlib__sliding_windowS");
   u00266 : constant Version_32 := 16#b518d9fb#;
   pragma Export (C, u00266, "zlib__stream_inflateB");
   u00267 : constant Version_32 := 16#cacb4523#;
   pragma Export (C, u00267, "zlib__stream_inflateS");
   u00268 : constant Version_32 := 16#8171018e#;
   pragma Export (C, u00268, "version__promisorB");
   u00269 : constant Version_32 := 16#7cdbd3ff#;
   pragma Export (C, u00269, "version__promisorS");
   u00270 : constant Version_32 := 16#49c6cdc5#;
   pragma Export (C, u00270, "version__fetchB");
   u00271 : constant Version_32 := 16#cc56a623#;
   pragma Export (C, u00271, "version__fetchS");
   ...
   u00431 : constant Version_32 := 16#a143e1e2#;
   pragma Export (C, u00431, "version__revisionsB");
   u00432 : constant Version_32 := 16#e5e3d1f1#;
   pragma Export (C, u00432, "version__revisionsS");
   u00433 : constant Version_32 := 16#d138c680#;
   pragma Export (C, u00433, "version__ref_cacheB");
   u00434 : constant Version_32 := 16#5d9057e8#;
   pragma Export (C, u00434, "version__ref_cacheS");
   u00435 : constant Version_32 := 16#f4ea0920#;
   pragma Export (C, u00435, "version__tarB");
   u00436 : constant Version_32 := 16#b2ac63ea#;
   pragma Export (C, u00436, "version__tarS");
   u00437 : constant Version_32 := 16#2d5f8171#;
   pragma Export (C, u00437, "version__tree_cacheB");
   u00438 : constant Version_32 := 16#5f07da63#;
   pragma Export (C, u00438, "version__tree_cacheS");
   u00439 : constant Version_32 := 16#21a41f23#;
   pragma Export (C, u00439, "version__zipB");
   u00440 : constant Version_32 := 16#bfe8ce7e#;
   pragma Export (C, u00440, "version__zipS");
   u00441 : constant Version_32 := 16#f95e3a99#;
   pragma Export (C, u00441, "version__pathspecB");
   u00442 : constant Version_32 := 16#65a84860#;
   pragma Export (C, u00442, "version__pathspecS");
