...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_version_metadata" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9bddb055#;
   pragma Export (C, u00001, "check_version_metadataB");
   ...
   u00144 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00144, "system__concat_2B");
   u00145 : constant Version_32 := 16#a1d318f8#;
   pragma Export (C, u00145, "system__concat_2S");
   u00146 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00146, "system__concat_3B");
   u00147 : constant Version_32 := 16#9e5272ad#;
   pragma Export (C, u00147, "system__concat_3S");
   u00148 : constant Version_32 := 16#3e1fdabc#;
   pragma Export (C, u00148, "tool_supportB");
   u00149 : constant Version_32 := 16#86235692#;
   pragma Export (C, u00149, "tool_supportS");
   u00150 : constant Version_32 := 16#85b92d20#;
   pragma Export (C, u00150, "ada__directoriesB");
   u00151 : constant Version_32 := 16#c1305a6c#;
   pragma Export (C, u00151, "ada__directoriesS");
   u00152 : constant Version_32 := 16#78511131#;
   pragma Export (C, u00152, "ada__calendarB");
   u00153 : constant Version_32 := 16#c907a168#;
   pragma Export (C, u00153, "ada__calendarS");
   u00154 : constant Version_32 := 16#d172d809#;
   pragma Export (C, u00154, "system__os_primitivesB");
   u00155 : constant Version_32 := 16#13d50ef9#;
   pragma Export (C, u00155, "system__os_primitivesS");
   u00156 : constant Version_32 := 16#c1ef1512#;
   pragma Export (C, u00156, "ada__calendar__formattingB");
   u00157 : constant Version_32 := 16#5a9d5c4e#;
   pragma Export (C, u00157, "ada__calendar__formattingS");
   u00158 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00158, "ada__calendar__time_zonesB");
   u00159 : constant Version_32 := 16#55da5b9f#;
   pragma Export (C, u00159, "ada__calendar__time_zonesS");
   u00160 : constant Version_32 := 16#0a4a0a25#;
   pragma Export (C, u00160, "system__val_fixed_64S");
   u00161 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00161, "system__arith_64B");
   u00162 : constant Version_32 := 16#509fabdd#;
   pragma Export (C, u00162, "system__arith_64S");
   u00163 : constant Version_32 := 16#aa0160a2#;
   pragma Export (C, u00163, "system__val_intS");
   u00164 : constant Version_32 := 16#5da6ebca#;
   pragma Export (C, u00164, "system__val_unsS");
   u00165 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00165, "ada__containers__helpersB");
   u00166 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00166, "ada__containers__helpersS");
   u00167 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00167, "system__atomic_countersB");
   u00168 : constant Version_32 := 16#c83084cc#;
   pragma Export (C, u00168, "system__atomic_countersS");
   u00169 : constant Version_32 := 16#1dec9118#;
   pragma Export (C, u00169, "ada__directories__hierarchical_file_namesB");
   u00170 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00170, "ada__directories__hierarchical_file_namesS");
   u00171 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00171, "ada__directories__validityB");
   u00172 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00172, "ada__directories__validityS");
   u00173 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00173, "ada__strings__unboundedB");
   u00174 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00174, "ada__strings__unboundedS");
   u00175 : constant Version_32 := 16#d79db92c#;
   pragma Export (C, u00175, "system__return_stackS");
   u00176 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00176, "system__stream_attributesB");
   u00177 : constant Version_32 := 16#a8236f45#;
   pragma Export (C, u00177, "system__stream_attributesS");
   u00178 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00178, "system__stream_attributes__xdrB");
   u00179 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00179, "system__stream_attributes__xdrS");
   u00180 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00180, "system__fat_fltS");
   u00181 : constant Version_32 := 16#f128bd6e#;
   pragma Export (C, u00181, "system__fat_lfltS");
   u00182 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00182, "system__fat_llfS");
   u00183 : constant Version_32 := 16#aaf681ed#;
   pragma Export (C, u00183, "system__file_attributesS");
   u00184 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00184, "system__regexpB");
   u00185 : constant Version_32 := 16#371accc3#;
   ...
   u00187 : constant Version_32 := 16#8e431254#;
   pragma Export (C, u00187, "system__storage_poolsS");
   u00188 : constant Version_32 := 16#8d235f7e#;
   pragma Export (C, u00188, "ada__environment_variablesB");
   u00189 : constant Version_32 := 16#767099b7#;
   pragma Export (C, u00189, "ada__environment_variablesS");
   u00190 : constant Version_32 := 16#58c21abc#;
   pragma Export (C, u00190, "interfaces__c__stringsB");
   u00191 : constant Version_32 := 16#bd4557ce#;
   ...
   u00194 : constant Version_32 := 16#377f12dc#;
   pragma Export (C, u00194, "project_toolsS");
   u00195 : constant Version_32 := 16#e9e36e2f#;
   pragma Export (C, u00195, "project_tools__filesB");
   u00196 : constant Version_32 := 16#a52fdcb7#;
   pragma Export (C, u00196, "project_tools__filesS");
   u00197 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00197, "ada__streams__stream_ioB");
   u00198 : constant Version_32 := 16#5dc4c9e4#;
   ...
   u00200 : constant Version_32 := 16#bb9c8d3c#;
   pragma Export (C, u00200, "system__communicationS");
   u00201 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00201, "gnat__regexpS");
   u00202 : constant Version_32 := 16#3f48f1e0#;
   pragma Export (C, u00202, "project_tools__linksB");
   u00203 : constant Version_32 := 16#e9bbd0e5#;
   pragma Export (C, u00203, "project_tools__linksS");
   u00204 : constant Version_32 := 16#e1a42fe0#;
   pragma Export (C, u00204, "project_tools__textB");
   u00205 : constant Version_32 := 16#c1e397fc#;
   pragma Export (C, u00205, "project_tools__textS");
   u00206 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00206, "system__pool_globalB");
   u00207 : constant Version_32 := 16#a07c1f1e#;
   pragma Export (C, u00207, "system__pool_globalS");
   u00208 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00208, "system__memoryB");
   u00209 : constant Version_32 := 16#0cbcf715#;
   pragma Export (C, u00209, "system__memoryS");
   u00210 : constant Version_32 := 16#690693e0#;
   pragma Export (C, u00210, "system__storage_pools__subpoolsB");
   u00211 : constant Version_32 := 16#23a252fc#;
   pragma Export (C, u00211, "system__storage_pools__subpoolsS");
   u00212 : constant Version_32 := 16#3676fd0b#;
   pragma Export (C, u00212, "system__storage_pools__subpools__finalizationB");
   u00213 : constant Version_32 := 16#54c94065#;
   pragma Export (C, u00213, "system__storage_pools__subpools__finalizationS");
   u00214 : constant Version_32 := 16#b3f7543e#;
   pragma Export (C, u00214, "system__strings__stream_opsB");
   u00215 : constant Version_32 := 16#46dadf54#;
   pragma Export (C, u00215, "system__strings__stream_opsS");
   u00216 : constant Version_32 := 16#4dc22731#;
   pragma Export (C, u00216, "project_tools__processesB");
   u00217 : constant Version_32 := 16#2f8c02d0#;
   pragma Export (C, u00217, "project_tools__processesS");
   u00218 : constant Version_32 := 16#77ff997b#;
   pragma Export (C, u00218, "gnat__expectB");
   u00219 : constant Version_32 := 16#f07e46eb#;
   pragma Export (C, u00219, "gnat__expectS");
   u00220 : constant Version_32 := 16#8099c5e3#;
   pragma Export (C, u00220, "gnat__ioB");
   u00221 : constant Version_32 := 16#2a95b695#;
   pragma Export (C, u00221, "gnat__ioS");
   u00222 : constant Version_32 := 16#3254c51b#;
   pragma Export (C, u00222, "gnat__regpatS");
   u00223 : constant Version_32 := 16#b2df5ff8#;
   pragma Export (C, u00223, "system__regpatB");
   u00224 : constant Version_32 := 16#2bb9aadc#;
   pragma Export (C, u00224, "system__regpatS");
   u00225 : constant Version_32 := 16#7c5a5793#;
   pragma Export (C, u00225, "system__img_charB");
   u00226 : constant Version_32 := 16#881c33e8#;
