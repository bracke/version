...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_platform_ci_evidence_selftest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#19fc0d2d#;
   pragma Export (C, u00001, "check_platform_ci_evidence_selftestB");
   ...
   u00184 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00184, "system__concat_3B");
   u00185 : constant Version_32 := 16#9e5272ad#;
   ...
   --  tool_support%s
   --  tool_support%b
   --  check_platform_ci_evidence_selftest%b
