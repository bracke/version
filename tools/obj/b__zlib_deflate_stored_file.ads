...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_zlib_deflate_stored_file" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ea9a4ca1#;
   pragma Export (C, u00001, "zlib_deflate_stored_fileB");
   ...
   u00140 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00140, "system__concat_2B");
   u00141 : constant Version_32 := 16#a1d318f8#;
   pragma Export (C, u00141, "system__concat_2S");
   u00142 : constant Version_32 := 16#3ad840e5#;
   pragma Export (C, u00142, "zlibB");
   u00143 : constant Version_32 := 16#9b7d9fc9#;
   pragma Export (C, u00143, "zlibS");
   u00144 : constant Version_32 := 16#78511131#;
   pragma Export (C, u00144, "ada__calendarB");
   u00145 : constant Version_32 := 16#c907a168#;
   ...
   u00148 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00148, "ada__containers__helpersB");
   u00149 : constant Version_32 := 16#444c93c2#;
   ...
   u00152 : constant Version_32 := 16#85b92d20#;
   pragma Export (C, u00152, "ada__directoriesB");
   u00153 : constant Version_32 := 16#c1305a6c#;
   pragma Export (C, u00153, "ada__directoriesS");
   u00154 : constant Version_32 := 16#c1ef1512#;
   pragma Export (C, u00154, "ada__calendar__formattingB");
   u00155 : constant Version_32 := 16#5a9d5c4e#;
   pragma Export (C, u00155, "ada__calendar__formattingS");
   u00156 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00156, "ada__calendar__time_zonesB");
   u00157 : constant Version_32 := 16#55da5b9f#;
   pragma Export (C, u00157, "ada__calendar__time_zonesS");
   u00158 : constant Version_32 := 16#0a4a0a25#;
   pragma Export (C, u00158, "system__val_fixed_64S");
   u00159 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00159, "system__arith_64B");
   u00160 : constant Version_32 := 16#509fabdd#;
   pragma Export (C, u00160, "system__arith_64S");
   u00161 : constant Version_32 := 16#aa0160a2#;
   pragma Export (C, u00161, "system__val_intS");
   u00162 : constant Version_32 := 16#5da6ebca#;
   pragma Export (C, u00162, "system__val_unsS");
   u00163 : constant Version_32 := 16#1dec9118#;
   pragma Export (C, u00163, "ada__directories__hierarchical_file_namesB");
   u00164 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00164, "ada__directories__hierarchical_file_namesS");
   u00165 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00165, "ada__directories__validityB");
   u00166 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00166, "ada__directories__validityS");
   u00167 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00167, "ada__strings__fixedB");
   u00168 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00168, "ada__strings__fixedS");
   u00169 : constant Version_32 := 16#b40d9bf2#;
   pragma Export (C, u00169, "ada__strings__searchB");
   u00170 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00170, "ada__strings__searchS");
   u00171 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00171, "ada__strings__unboundedB");
   u00172 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00172, "ada__strings__unboundedS");
   u00173 : constant Version_32 := 16#d79db92c#;
   pragma Export (C, u00173, "system__return_stackS");
   u00174 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00174, "system__stream_attributesB");
   u00175 : constant Version_32 := 16#a8236f45#;
   pragma Export (C, u00175, "system__stream_attributesS");
   u00176 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00176, "system__stream_attributes__xdrB");
   u00177 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00177, "system__stream_attributes__xdrS");
   u00178 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00178, "system__fat_fltS");
   u00179 : constant Version_32 := 16#f128bd6e#;
   pragma Export (C, u00179, "system__fat_lfltS");
   u00180 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00180, "system__fat_llfS");
   u00181 : constant Version_32 := 16#aaf681ed#;
   ...
   u00186 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00186, "ada__streams__stream_ioB");
   u00187 : constant Version_32 := 16#5dc4c9e4#;
   pragma Export (C, u00187, "ada__streams__stream_ioS");
   u00188 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00188, "system__communicationB");
   u00189 : constant Version_32 := 16#bb9c8d3c#;
   ...
   u00200 : constant Version_32 := 16#7e239593#;
   pragma Export (C, u00200, "zlib__bit_writerB");
   u00201 : constant Version_32 := 16#97d2a07b#;
   pragma Export (C, u00201, "zlib__bit_writerS");
   u00202 : constant Version_32 := 16#8668c60d#;
   pragma Export (C, u00202, "zlib__block_chooserB");
   u00203 : constant Version_32 := 16#a38f219b#;
   pragma Export (C, u00203, "zlib__block_chooserS");
   u00204 : constant Version_32 := 16#02d3ebec#;
   pragma Export (C, u00204, "zlib__deflate_tablesB");
   u00205 : constant Version_32 := 16#d36f2066#;
   pragma Export (C, u00205, "zlib__deflate_tablesS");
   u00206 : constant Version_32 := 16#df91fc6b#;
   pragma Export (C, u00206, "zlib__huffmanB");
   u00207 : constant Version_32 := 16#a02ed816#;
   pragma Export (C, u00207, "zlib__huffmanS");
   u00208 : constant Version_32 := 16#3c6bf20b#;
   pragma Export (C, u00208, "zlib__bitsB");
   u00209 : constant Version_32 := 16#37cfd778#;
   pragma Export (C, u00209, "zlib__bitsS");
   u00210 : constant Version_32 := 16#69d79c60#;
   pragma Export (C, u00210, "zlib__stream_bitsB");
   u00211 : constant Version_32 := 16#e757f448#;
   pragma Export (C, u00211, "zlib__stream_bitsS");
   u00212 : constant Version_32 := 16#502d00b1#;
   pragma Export (C, u00212, "zlib__fixed_compressB");
   u00213 : constant Version_32 := 16#0f6ccf11#;
   pragma Export (C, u00213, "zlib__fixed_compressS");
   u00214 : constant Version_32 := 16#99853839#;
   pragma Export (C, u00214, "zlib__checksumsB");
   u00215 : constant Version_32 := 16#60db1c89#;
   pragma Export (C, u00215, "zlib__checksumsS");
   u00216 : constant Version_32 := 16#dd25c8e9#;
   pragma Export (C, u00216, "zlib__lz77_matcherB");
   u00217 : constant Version_32 := 16#2c08e160#;
   pragma Export (C, u00217, "zlib__lz77_matcherS");
   u00218 : constant Version_32 := 16#986d251a#;
   pragma Export (C, u00218, "zlib__huffman_builderB");
   u00219 : constant Version_32 := 16#c4db564e#;
   pragma Export (C, u00219, "zlib__huffman_builderS");
   u00220 : constant Version_32 := 16#3a0a2521#;
   pragma Export (C, u00220, "zlib__crc32_internalB");
   u00221 : constant Version_32 := 16#54dd0ae1#;
   pragma Export (C, u00221, "zlib__crc32_internalS");
   u00222 : constant Version_32 := 16#273c1bb0#;
   pragma Export (C, u00222, "zlib__sliding_windowB");
   u00223 : constant Version_32 := 16#18522695#;
   pragma Export (C, u00223, "zlib__sliding_windowS");
   u00224 : constant Version_32 := 16#b518d9fb#;
   pragma Export (C, u00224, "zlib__stream_inflateB");
   u00225 : constant Version_32 := 16#cacb4523#;
   pragma Export (C, u00225, "zlib__stream_inflateS");
