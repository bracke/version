...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_release_consistency_selftest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6697d8b1#;
   pragma Export (C, u00001, "check_release_consistency_selftestB");
   ...
   --  tool_support%s
   --  tool_support%b
   --  check_release_consistency_selftest%b
