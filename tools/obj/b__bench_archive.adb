pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__bench_archive.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__bench_archive.adb");
...
package body ada_main is
   ...
   E227 : Short_Integer; pragma Import (Ada, E227, "interfaces__c__strings_E");
   ...
   E209 : Short_Integer; pragma Import (Ada, E209, "ada__streams__stream_io_E");
   ...
   E233 : Short_Integer; pragma Import (Ada, E233, "version__hash_E");
   E221 : Short_Integer; pragma Import (Ada, E221, "version__path_safety_E");
   E317 : Short_Integer; pragma Import (Ada, E317, "version__pkt_line_E");
   E223 : Short_Integer; pragma Import (Ada, E223, "version__platform_E");
   E207 : Short_Integer; pragma Import (Ada, E207, "version__files_E");
   E213 : Short_Integer; pragma Import (Ada, E213, "version__files__internal_E");
   E217 : Short_Integer; pragma Import (Ada, E217, "version__files__rollback_E");
   E219 : Short_Integer; pragma Import (Ada, E219, "version__filesystem_guard_E");
   E309 : Short_Integer; pragma Import (Ada, E309, "version__ref_names_E");
   E436 : Short_Integer; pragma Import (Ada, E436, "version__tar_E");
   ...
   E442 : Short_Integer; pragma Import (Ada, E442, "version__pathspec_E");
   E241 : Short_Integer; pragma Import (Ada, E241, "zlib_E");
   E243 : Short_Integer; pragma Import (Ada, E243, "zlib__bit_writer_E");
   E251 : Short_Integer; pragma Import (Ada, E251, "zlib__bits_E");
   E257 : Short_Integer; pragma Import (Ada, E257, "zlib__checksums_E");
   E263 : Short_Integer; pragma Import (Ada, E263, "zlib__crc32_internal_E");
   E255 : Short_Integer; pragma Import (Ada, E255, "zlib__fixed_compress_E");
   E261 : Short_Integer; pragma Import (Ada, E261, "zlib__huffman_builder_E");
   E259 : Short_Integer; pragma Import (Ada, E259, "zlib__lz77_matcher_E");
   E245 : Short_Integer; pragma Import (Ada, E245, "zlib__block_chooser_E");
   E265 : Short_Integer; pragma Import (Ada, E265, "zlib__sliding_window_E");
   E253 : Short_Integer; pragma Import (Ada, E253, "zlib__stream_bits_E");
   E249 : Short_Integer; pragma Import (Ada, E249, "zlib__huffman_E");
   E247 : Short_Integer; pragma Import (Ada, E247, "zlib__deflate_tables_E");
   E267 : Short_Integer; pragma Import (Ada, E267, "zlib__stream_inflate_E");
   ...
   E239 : Short_Integer; pragma Import (Ada, E239, "version__compression_E");
   E321 : Short_Integer; pragma Import (Ada, E321, "version__transport__http_E");
   E237 : Short_Integer; pragma Import (Ada, E237, "version__objects_E");
   E271 : Short_Integer; pragma Import (Ada, E271, "version__fetch_E");
   E231 : Short_Integer; pragma Import (Ada, E231, "version__pack_E");
   E235 : Short_Integer; pragma Import (Ada, E235, "version__pack_index_E");
   E313 : Short_Integer; pragma Import (Ada, E313, "version__packed_refs_E");
   E269 : Short_Integer; pragma Import (Ada, E269, "version__promisor_E");
   ...
   E229 : Short_Integer; pragma Import (Ada, E229, "version__object_cache_E");
   E434 : Short_Integer; pragma Import (Ada, E434, "version__ref_cache_E");
   E432 : Short_Integer; pragma Import (Ada, E432, "version__revisions_E");
   E438 : Short_Integer; pragma Import (Ada, E438, "version__tree_cache_E");
   E440 : Short_Integer; pragma Import (Ada, E440, "version__zip_E");
   E190 : Short_Integer; pragma Import (Ada, E190, "version__archive_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "version__archive__finalize_body");
      begin
         E190 := E190 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "version__zip__finalize_spec");
      begin
         F2;
      end;
      E438 := E438 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "version__tree_cache__finalize_spec");
      begin
         F3;
      end;
      E434 := E434 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "version__ref_cache__finalize_spec");
      begin
         F4;
      end;
      E229 := E229 - 1;
      declare
         procedure F5;
         pragma Import (Ada, F5, "version__object_cache__finalize_spec");
      begin
         F5;
      end;
      declare
         procedure F6;
         pragma Import (Ada, F6, "version__pack_index_cache__finalize_body");
      begin
         E430 := E430 - 1;
         F6;
      end;
      declare
         procedure F7;
         pragma Import (Ada, F7, "version__pack_index_cache__finalize_spec");
      begin
         F7;
      end;
      declare
         procedure F8;
         pragma Import (Ada, F8, "version__fetch__finalize_body");
      begin
         E271 := E271 - 1;
         F8;
      end;
      ...
      declare
         procedure F9;
         pragma Import (Ada, F9, "version__upload_pack__finalize_spec");
      begin
         F9;
      end;
      declare
         procedure F10;
         pragma Import (Ada, F10, "version__shallow__finalize_body");
      begin
         E319 := E319 - 1;
         F10;
      end;
      ...
      declare
         procedure F11;
         pragma Import (Ada, F11, "version__refs__finalize_spec");
      begin
         F11;
      end;
      declare
         procedure F12;
         pragma Import (Ada, F12, "version__ref_transaction__finalize_spec");
      begin
         F12;
      end;
      E237 := E237 - 1;
      ...
      declare
         procedure F13;
         pragma Import (Ada, F13, "version__packed_refs__finalize_spec");
      begin
         F13;
      end;
      declare
         procedure F14;
         pragma Import (Ada, F14, "version__pack__finalize_body");
      begin
         E231 := E231 - 1;
         F14;
      end;
      ...
      declare
         procedure F15;
         pragma Import (Ada, F15, "version__pack_index__finalize_spec");
      begin
         F15;
      end;
      declare
         procedure F16;
         pragma Import (Ada, F16, "version__objects__finalize_spec");
      begin
         F16;
      end;
      E340 := E340 - 1;
      declare
         procedure F17;
         pragma Import (Ada, F17, "http_client__response_streams__finalize_spec");
      begin
         F17;
      end;
      declare
         procedure F18;
         pragma Import (Ada, F18, "zlib__finalize_body");
      begin
         E241 := E241 - 1;
         F18;
      end;
      ...
      declare
         procedure F19;
         pragma Import (Ada, F19, "zlib__bits__finalize_spec");
      begin
         F19;
      end;
      E243 := E243 - 1;
      declare
         procedure F20;
         pragma Import (Ada, F20, "zlib__bit_writer__finalize_spec");
      begin
         F20;
      end;
      E442 := E442 - 1;
      declare
         procedure F21;
         pragma Import (Ada, F21, "version__pathspec__finalize_spec");
      begin
         F21;
      end;
      E296 := E296 - 1;
      declare
         procedure F22;
         pragma Import (Ada, F22, "version__config__finalize_spec");
      begin
         F22;
      end;
      declare
         procedure F23;
         pragma Import (Ada, F23, "version__transport__local__finalize_body");
      begin
         E305 := E305 - 1;
         F23;
      end;
      declare
         procedure F24;
         pragma Import (Ada, F24, "version__transport__local__finalize_spec");
      begin
         F24;
      end;
      E436 := E436 - 1;
      declare
         procedure F25;
         pragma Import (Ada, F25, "version__tar__finalize_spec");
      begin
         F25;
      end;
      E219 := E219 - 1;
      declare
         procedure F26;
         pragma Import (Ada, F26, "version__filesystem_guard__finalize_spec");
      begin
         F26;
      end;
      E317 := E317 - 1;
      declare
         procedure F27;
         pragma Import (Ada, F27, "version__pkt_line__finalize_spec");
      begin
         F27;
      end;
      E221 := E221 - 1;
      declare
         procedure F28;
         pragma Import (Ada, F28, "version__path_safety__finalize_spec");
      begin
         F28;
      end;
      E392 := E392 - 1;
      declare
         procedure F29;
         pragma Import (Ada, F29, "http_client__transports__tls__finalize_spec");
      begin
         F29;
      end;
      E397 := E397 - 1;
      declare
         procedure F30;
         pragma Import (Ada, F30, "http_client__transports__tcp__finalize_spec");
      begin
         F30;
      end;
      E350 := E350 - 1;
      declare
         procedure F31;
         pragma Import (Ada, F31, "http_client__cookies__finalize_spec");
      begin
         F31;
      end;
      declare
         procedure F32;
         pragma Import (Ada, F32, "http_client__uri__finalize_body");
      begin
         E335 := E335 - 1;
         F32;
      end;
      ...
      declare
         procedure F33;
         pragma Import (Ada, F33, "http_client__diagnostics__finalize_spec");
      begin
         F33;
      end;
      E332 := E332 - 1;
      declare
         procedure F34;
         pragma Import (Ada, F34, "http_client__request_bodies__finalize_spec");
      begin
         F34;
      end;
      E380 := E380 - 1;
      declare
         procedure F35;
         pragma Import (Ada, F35, "http_client__quic__finalize_spec");
      begin
         F35;
      end;
      E326 := E326 - 1;
      declare
         procedure F36;
         pragma Import (Ada, F36, "http_client__headers__finalize_spec");
      begin
         F36;
      end;
      declare
         procedure F37;
         pragma Import (Ada, F37, "ada__directories__finalize_body");
      begin
         E109 := E109 - 1;
         F37;
      end;
      ...
      declare
         procedure F42;
         pragma Import (Ada, F42, "gnat__expect__finalize_spec");
      begin
         F42;
      end;
      E197 := E197 - 1;
      ...
      declare
         procedure F44;
         pragma Import (Ada, F44, "ada__text_io__finalize_spec");
      begin
         F44;
      end;
      E157 := E157 - 1;
      declare
         procedure F45;
         pragma Import (Ada, F45, "ada__strings__unbounded__finalize_spec");
      begin
         F45;
      end;
      E201 := E201 - 1;
      ...
      declare
         procedure F47;
         pragma Import (Ada, F47, "ada__streams__stream_io__finalize_spec");
      begin
         F47;
      end;
      declare
         procedure F48;
         pragma Import (Ada, F48, "system__file_io__finalize_body");
      begin
         E172 := E172 - 1;
         F48;
      end;
   ...
   begin
      ...
      E438 := E438 + 1;
      if E440 = 0 then
         Version.Zip'Elab_Spec;
      end if;
      E440 := E440 + 1;
      if E190 = 0 then
         Version.Archive'Elab_Body;
      end if;
      E190 := E190 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_bench_archive");
...
--  BEGIN Object file/option list
   --   /home/bent/Projekte/Ada/version/tools/obj/bench_archive.o
