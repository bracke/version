...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_release_manifests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2d2033ce#;
   pragma Export (C, u00001, "check_release_manifestsB");
   ...
   u00143 : constant Version_32 := 16#23d9f0e9#;
