...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_release_package" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fb3fd9c6#;
   pragma Export (C, u00001, "check_release_packageB");
   ...
   u00142 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00142, "system__concat_3B");
   u00143 : constant Version_32 := 16#9e5272ad#;
   pragma Export (C, u00143, "system__concat_3S");
   u00144 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00144, "system__concat_4B");
   u00145 : constant Version_32 := 16#27d03431#;
   pragma Export (C, u00145, "system__concat_4S");
   u00146 : constant Version_32 := 16#3e1fdabc#;
   pragma Export (C, u00146, "tool_supportB");
   u00147 : constant Version_32 := 16#86235692#;
   pragma Export (C, u00147, "tool_supportS");
   u00148 : constant Version_32 := 16#85b92d20#;
   pragma Export (C, u00148, "ada__directoriesB");
   u00149 : constant Version_32 := 16#c1305a6c#;
   pragma Export (C, u00149, "ada__directoriesS");
   u00150 : constant Version_32 := 16#78511131#;
   pragma Export (C, u00150, "ada__calendarB");
   u00151 : constant Version_32 := 16#c907a168#;
   pragma Export (C, u00151, "ada__calendarS");
   u00152 : constant Version_32 := 16#d172d809#;
   pragma Export (C, u00152, "system__os_primitivesB");
   u00153 : constant Version_32 := 16#13d50ef9#;
   ...
   u00163 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00163, "ada__containers__helpersB");
   u00164 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00164, "ada__containers__helpersS");
   u00165 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00165, "system__atomic_countersB");
   u00166 : constant Version_32 := 16#c83084cc#;
   pragma Export (C, u00166, "system__atomic_countersS");
   u00167 : constant Version_32 := 16#1dec9118#;
   pragma Export (C, u00167, "ada__directories__hierarchical_file_namesB");
   u00168 : constant Version_32 := 16#34d5eeb2#;
   pragma Export (C, u00168, "ada__directories__hierarchical_file_namesS");
   u00169 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00169, "ada__directories__validityB");
   u00170 : constant Version_32 := 16#0877bcae#;
   pragma Export (C, u00170, "ada__directories__validityS");
   u00171 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00171, "ada__strings__fixedB");
   u00172 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00172, "ada__strings__fixedS");
   u00173 : constant Version_32 := 16#b40d9bf2#;
   pragma Export (C, u00173, "ada__strings__searchB");
   u00174 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00174, "ada__strings__searchS");
   u00175 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00175, "ada__strings__unboundedB");
   u00176 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00176, "ada__strings__unboundedS");
   u00177 : constant Version_32 := 16#d79db92c#;
   pragma Export (C, u00177, "system__return_stackS");
   u00178 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00178, "system__stream_attributesB");
   u00179 : constant Version_32 := 16#a8236f45#;
   pragma Export (C, u00179, "system__stream_attributesS");
   u00180 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00180, "system__stream_attributes__xdrB");
   u00181 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00181, "system__stream_attributes__xdrS");
   u00182 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00182, "system__fat_fltS");
   u00183 : constant Version_32 := 16#f128bd6e#;
   pragma Export (C, u00183, "system__fat_lfltS");
   u00184 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00184, "system__fat_llfS");
   u00185 : constant Version_32 := 16#aaf681ed#;
   pragma Export (C, u00185, "system__file_attributesS");
   u00186 : constant Version_32 := 16#8f8e85c2#;
   pragma Export (C, u00186, "system__regexpB");
   u00187 : constant Version_32 := 16#371accc3#;
   pragma Export (C, u00187, "system__regexpS");
   u00188 : constant Version_32 := 16#35d6ef80#;
   pragma Export (C, u00188, "system__storage_poolsB");
   u00189 : constant Version_32 := 16#8e431254#;
   pragma Export (C, u00189, "system__storage_poolsS");
   u00190 : constant Version_32 := 16#8d235f7e#;
   pragma Export (C, u00190, "ada__environment_variablesB");
   u00191 : constant Version_32 := 16#767099b7#;
   pragma Export (C, u00191, "ada__environment_variablesS");
   u00192 : constant Version_32 := 16#58c21abc#;
   pragma Export (C, u00192, "interfaces__c__stringsB");
   u00193 : constant Version_32 := 16#bd4557ce#;
   pragma Export (C, u00193, "interfaces__c__stringsS");
   u00194 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00194, "gnatS");
   u00195 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00195, "gnat__os_libS");
   u00196 : constant Version_32 := 16#377f12dc#;
   pragma Export (C, u00196, "project_toolsS");
   u00197 : constant Version_32 := 16#e9e36e2f#;
   pragma Export (C, u00197, "project_tools__filesB");
   u00198 : constant Version_32 := 16#a52fdcb7#;
   pragma Export (C, u00198, "project_tools__filesS");
   u00199 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00199, "ada__streams__stream_ioB");
   u00200 : constant Version_32 := 16#5dc4c9e4#;
   ...
   u00202 : constant Version_32 := 16#bb9c8d3c#;
   pragma Export (C, u00202, "system__communicationS");
   u00203 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00203, "gnat__regexpS");
   u00204 : constant Version_32 := 16#3f48f1e0#;
   pragma Export (C, u00204, "project_tools__linksB");
   u00205 : constant Version_32 := 16#e9bbd0e5#;
   pragma Export (C, u00205, "project_tools__linksS");
   u00206 : constant Version_32 := 16#e1a42fe0#;
   pragma Export (C, u00206, "project_tools__textB");
   u00207 : constant Version_32 := 16#c1e397fc#;
   pragma Export (C, u00207, "project_tools__textS");
   u00208 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00208, "system__pool_globalB");
   u00209 : constant Version_32 := 16#a07c1f1e#;
   pragma Export (C, u00209, "system__pool_globalS");
   u00210 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00210, "system__memoryB");
   u00211 : constant Version_32 := 16#0cbcf715#;
   ...
   u00216 : constant Version_32 := 16#b3f7543e#;
   pragma Export (C, u00216, "system__strings__stream_opsB");
   u00217 : constant Version_32 := 16#46dadf54#;
   pragma Export (C, u00217, "system__strings__stream_opsS");
   u00218 : constant Version_32 := 16#4dc22731#;
   pragma Export (C, u00218, "project_tools__processesB");
   u00219 : constant Version_32 := 16#2f8c02d0#;
   pragma Export (C, u00219, "project_tools__processesS");
   u00220 : constant Version_32 := 16#77ff997b#;
   pragma Export (C, u00220, "gnat__expectB");
   u00221 : constant Version_32 := 16#f07e46eb#;
   pragma Export (C, u00221, "gnat__expectS");
   u00222 : constant Version_32 := 16#8099c5e3#;
   pragma Export (C, u00222, "gnat__ioB");
   u00223 : constant Version_32 := 16#2a95b695#;
   pragma Export (C, u00223, "gnat__ioS");
   u00224 : constant Version_32 := 16#3254c51b#;
   pragma Export (C, u00224, "gnat__regpatS");
   u00225 : constant Version_32 := 16#b2df5ff8#;
   pragma Export (C, u00225, "system__regpatB");
   u00226 : constant Version_32 := 16#2bb9aadc#;
   pragma Export (C, u00226, "system__regpatS");
   u00227 : constant Version_32 := 16#7c5a5793#;
   pragma Export (C, u00227, "system__img_charB");
   u00228 : constant Version_32 := 16#881c33e8#;
   pragma Export (C, u00228, "system__img_charS");
