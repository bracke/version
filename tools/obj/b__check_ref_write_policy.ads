...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_ref_write_policy" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6c2fdd0b#;
   pragma Export (C, u00001, "check_ref_write_policyB");
