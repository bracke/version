...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_check_ref_write_policy_selftest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1b2e6162#;
   pragma Export (C, u00001, "check_ref_write_policy_selftestB");
   ...
   --  tool_support%s
   --  tool_support%b
   --  check_ref_write_policy_selftest%b
