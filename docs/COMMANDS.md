...
Syntax: `version log [--all|--branches|--tags] [--author=<pat>] [--grep=<pat>] [-s|--no-patch] [--oneline] [--stat] [-p|--patch] [-U<n>|--unified=<n>] [--show-signature] [--format=<fmt>] [-<n>|-n <count>|--max-count=<n>] [--skip=<n>] [--reverse] [--merges|--no-merges] [--first-parent] [--topo-order|--date-order] [<REV>...] [--] [PATH...]`.
