...
Repository and maintenance: `init`, `clone`, `verify`, `repack`, `prune`, `gc`, `pack-refs`, `config list`, `config get`, `config set`, `config unset`.
