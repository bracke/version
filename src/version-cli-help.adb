...
package body Version.CLI.Help is
   ...
   begin
      if Name = "init" then
         ...
         Line ("Usage:");
         Line ("  version log [<options>] [<REV>...] [--] [PATH...]");
         Line ("  version log [<options>] --stdin");
         Line ("  version log [<options>] -g|--walk-reflogs [<ref>]");
         Line ("  version log [<options>] --merge");
         Line;
         Line ("Show commit history from HEAD or the given revisions, as git does.");
         Line ("Selection: --all, --branches[=<pat>], --tags[=<pat>], --remotes[=<pat>],");
         Line ("  --glob=, --exclude=, --bisect, --not, -<n>, --skip=, --since=/--until=");
         Line ("  (git's approxidate: '2 weeks ago', 'yesterday noon', 2024-01-02, ...),");
         Line ("  --author=, --committer=, --grep= (-i, -E, -F, -P, --all-match,");
         Line ("  --invert-grep), -S, -G, --merges/--no-merges, --min/max-parents=,");
         Line ("  --first-parent, --ancestry-path[=<c>], --full-history, --sparse,");
         Line ("  --simplify-merges, --simplify-by-decoration, --follow, --no-walk.");
         Line ("Order: --topo-order, --date-order, --author-date-order, --reverse.");
         Line ("Layout: --oneline, --pretty=/--format= (short|medium|full|fuller|reference|");
         Line ("  email|raw|format:|tformat:|<%fmt>|pretty.<alias>), --date=<mode>,");
         Line ("  --abbrev-commit, --abbrev=<n>, --decorate[=..], --decorate-refs[-exclude]=,");
         Line ("  --source, --left-right, --cherry-mark, --boundary, --parents, --children,");
         Line ("  --graph, --show-linear-break, --log-size, -z, --expand-tabs[=n],");
